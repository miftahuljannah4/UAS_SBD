...
{	
	...
	"UPDATE transaksi SET id_trs='$id_trs',id_prd='$id_prd',id_pmb='$id_pmb', jml_prd='$jml_prd', harga_prd='$harga_prd', total_hrg='$total_hrg', tgl='$tgl' WHERE id_trs=$id");
...
<html lang="en">
    ...
    <body>
        ...
        <ul>
            <nav>
                <a class="btn btn-info" onclick="return confirm('Batal mengubah data?');" href="transaksi.php">KEMBALI</a>
            </nav>
        <br>
